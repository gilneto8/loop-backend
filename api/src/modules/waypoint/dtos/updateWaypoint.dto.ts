...
export default class updateWaypointDto implements TUpdateWaypoint {
  ...
  latitude!: Unnull<NexusGenInputs['FloatFieldUpdateOperationsInput']> | undefined;
  longitude!: Unnull<NexusGenInputs['FloatFieldUpdateOperationsInput']> | undefined;
  altitude!: Unnull<NexusGenInputs['NullableFloatFieldUpdateOperationsInput']> | undefined;
}
